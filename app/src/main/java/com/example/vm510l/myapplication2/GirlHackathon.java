...
public class GirlHackathon implements Comparable<GirlHackathon>{
    ...
    private static final String P12 = "24b9ef2a0e1e.p12";
    ...
    public static GoogleCredential createGoogleCredential() throws IOException,
        ...
        Log.d("warning:",GirlHackathon.class.toString());

        //File newfile=new File("test,txt");
        //AssetManager am = null;
        //InputStream f = mContext.getAssets().open("24b9ef2a0e1e.p12");
        //FileOutputStream fos = new FileOutputStream("/assets/24b9ef2a0e1e.p12");
        ...
        //fos.close();
       // File test = b/
        //InputStream is = GirlHackathon.class.getResourceAsStream(P12);
            //URL theCredential = GirlHackathon.class.getResource(P12);
       // File privateKey = new File(theCredential.toURI());
        KeyStore keystore = KeyStore.getInstance("PKCS12");
        keystore.load(GirlHackathon.class.getResourceAsStream(P12),"notasecret".toCharArray());
